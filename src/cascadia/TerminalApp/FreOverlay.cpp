...
namespace winrt::TerminalApp::implementation
{
    ...
    void FreOverlay::Initialize(const winrt::Microsoft::Terminal::Settings::Model::CascadiaSettings& settings)
    {
        ...
        ShowUsageToggle().OnContent(winrt::box_value(RS_(L"FreOverlay_ToggleOn")));
        ShowUsageToggle().OffContent(winrt::box_value(RS_(L"FreOverlay_ToggleOff")));
        ...
        ShowUsageToggle().IsOn(globals.ShowAgentUsage());
        ...
        Automation::AutomationProperties::SetName(
            ShowUsageToggle(), RS_(L"FreOverlay_ShowUsageLabel/Text"));
        Automation::AutomationProperties::SetName(
    ...
    IAsyncAction FreOverlay::_SaveAndInstallAsync()
    {
        ...
        if (_settings)
        {
            ...
            globals.ShowAgentUsage(ShowUsageToggle().IsOn());
        ...
        _agentPaneLog("[FRE] Save: agent=" + winrt::to_string(agentId)
            ...
            + " usage=" + (ShowUsageToggle().IsOn() ? "on" : "off")
