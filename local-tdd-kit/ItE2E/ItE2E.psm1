...
$publicFns = @(
    ...
    'Get-WtWindowIdentity', 'Invoke-WtWindowMouse', 'Invoke-WtWindowWheel', 'Send-WtWindowKey', 'Send-WtWindowKeyChord',
    'Set-WtWindowForeground', 'Test-WtWindowKeyFocusable', 'Open-WtSettings', 'Test-CommandPaletteOpen', 'Invoke-SettingsNav',
    # Observe
