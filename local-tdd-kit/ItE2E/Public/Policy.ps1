...
# cannot write it out of the box. Run local-tdd-kit/tools/Enable-WtAgentPolicyTesting.ps1 ONCE (it
    ...
    .SYNOPSIS
        ...
        policy. Two conditions:
          ...
          (b) We can actually WRITE the CurrentUser policy hive. Unlike the WinPS ExecutionPolicy
              ...
              to administrators. Run local-tdd-kit/tools/Enable-WtAgentPolicyTesting.ps1 ONCE (it
