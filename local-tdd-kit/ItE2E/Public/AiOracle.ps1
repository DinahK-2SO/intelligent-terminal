...
function Invoke-AgentJudge {
    ...
    if ($env:ITE2E_ENABLE_AI_ORACLE -ne '1') {
        throw 'Invoke-AgentJudge is disabled by default because it sends context to an external agent CLI. Set ITE2E_ENABLE_AI_ORACLE=1 after reviewing the data.'
    }
