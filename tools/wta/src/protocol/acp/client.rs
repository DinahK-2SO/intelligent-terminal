...
mod tests {
    ...
    use super::{
        ...
        post_login_authenticate_error, timeout_result_failure_fields, tool_call_exit_code,
        tool_call_kind_label, ClientState, PromptTimingState, PromptUsageIdentity, SoftStopReason,
        WtaClient,
    };
