@{
    ...
    'Completed turns toggle and select from rendered prompt targets' = 'Clicking a multiline prompt row selects and collapses its completed turn|Real agent completed turn supports prompt-row mouse toggle and input focus recovery'
